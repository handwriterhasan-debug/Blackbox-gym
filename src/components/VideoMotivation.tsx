...
export default function VideoMotivation() {
  return (
    <section className="relative py-32 bg-black border-y border-zinc-900 overflow-hidden">
      {/* Background */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          <h2 className="text-5xl sm:text-7xl font-display text-white mb-12 uppercase tracking-wide">
          ...
          <div className="relative cursor-pointer group inline-block">
            ...
            <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full border-4 border-primary flex items-center justify-center bg-black hover:bg-primary transition-colors duration-300 group-hover:scale-105 transform z-20">
              <Play className="w-12 h-12 sm:w-14 sm:h-14 text-primary group-hover:text-black ml-2" fill="currentColor" />
            </div>
          </div>
          
          <p className="mt-12 text-gray-400 font-sans text-lg max-w-2xl mx-auto font-light">
